...
public class FacebookIMessenger implements IMessengerInterface, ISearchInterface, IEditInterface {
    public String name;
    public int userId;

    public FacebookIMessenger(String name, int userId) {
        this.name = name;
        this.userId = userId;
    }

    public FacebookIMessenger() {
